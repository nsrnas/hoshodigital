...
$templateMap = [ordered]@{
  ...
  'page-customer-experience.php'   = 'page-customer-experience.php'
  'page-eci.php'                   = 'page-eci.php'
  'page-employee-experience.php'   = 'page-employee-experience.php'
  'page-operational-experience.php'= 'page-operational-experience.php'
