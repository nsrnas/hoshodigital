...
function hosho_primary_menu_fallback() { ?>
  <ul class="nav-links">
    ...
    <li class="menu-item-has-children"><a href="<?php echo esc_url( hosho_page_url( 'approach' ) ); ?>">Approach</a><ul class="sub-menu"><li><a href="<?php echo esc_url( home_url( '/ai/' ) ); ?>">AI</a></li><li><a href="<?php echo esc_url( home_url( '/ams/' ) ); ?>">AMS</a></li><li><a href="<?php echo esc_url( home_url( '/erp/' ) ); ?>">ERP</a></li></ul></li>
