...
function hosho_header_action() {
  $actions = array(
    ...
    'customer-intelligence' => array( 'Get in touch', hosho_page_url( 'contact' ) ),
    'workforce-intelligence' => array( 'Get in touch', hosho_page_url( 'contact' ) ),
