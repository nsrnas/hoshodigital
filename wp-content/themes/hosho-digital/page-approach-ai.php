...
<!-- =========================================================
	...
	<section class="ai-intro-section">
		<div class="container motion">
			...
			<div class="ai-intro-panel rapid-card">
				<h3>
					Beyond AI Models.
			...
			<div class="outcomes-grid motion">
				<div class="outcome-card">
					<div class="outcome-card__top">
						<div class="out-icon" aria-hidden="true"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="8"/><circle cx="12" cy="12" r="4"/><path d="M22 12h-2"/><path d="M4 12H2"/><path d="M12 2v2"/><path d="M12 20v2"/></svg></div>
				...
				<div class="outcome-card">
					<div class="outcome-card__top">
						<div class="out-icon" aria-hidden="true"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19h16"/><path d="M6 17V9"/><path d="M10 17V5"/><path d="M14 17v-4"/><path d="M18 17v-8"/></svg></div>
