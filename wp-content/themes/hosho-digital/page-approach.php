...
<main id="main-content" class="approach-page">
	...
	<!-- HERO -->
	<?php hosho_render_hero( "Don't Demolish<br>What's Working", 'approach/main/hero.jpg', array( 'class' => 'page-hero--company' ) ); ?>
		...
		<div class="fail-container">
			<div class="fail-intro">
				...
				<div class="fail-intro__copy">
					...
					<p>The gap between pilot and production is where value evaporates. We identify and neutralize the failure vectors inherent in standard transformation models.</p>
				</div>
			</div>
	...
	<section class="nodes-section">
		<div class="approach-intro motion">
			...
			<p>The Digital Core is the data and workflow layer that connects your existing systems so AI can act on real, current information. It sits underneath what you already run. It doesn't replace it.</p>
			<p>The intelligent Digital core links the 7 often disconnected elements of the enterprise digital core into a single loop, unifying the enterprise.</p>
		</div>
			...
			<div class="nodes-diagram-image">
				<div class="nodes-diagram-svg">
					<svg viewBox="0 0 640 560" xmlns="http://www.w3.org/2000/svg" aria-label="The Seven Nodes of Unity diagram">
						...
						<circle class="node-arc" cx="320" cy="280" r="210" fill="none" stroke="url(#nodeRingGradient)" stroke-linecap="round"/>
	...
	<section class="architecture-scale">
		<div class="container">
			<div class="architecture-header motion">
				...
				<p>We treat your enterprise architecture like a building: some layers are structural and shouldn't be touched carelessly, others are meant to be renovated often.</p>
			</div>
					...
					<div class="jh-image-col">
						<svg viewBox="0 0 460 365" xmlns="http://www.w3.org/2000/svg" class="jh-svg" aria-label="Japanese house structure diagram">
							...
							<g class="jh-part" data-key="roof" tabindex="0">
								<path d="M 210 45 L 250 45 L 420 155 L 40 155 Z" fill="#9aa5ad" stroke="#5c6570" stroke-width="2" stroke-linejoin="round"/>
								...
								<path d="M 30 155 L 430 155 L 408 170 L 52 170 Z" fill="#7c8790" stroke="#5c6570" stroke-width="1.5"/>
	...
	<section class="framework-section">
		<div class="framework-container">
			<div class="framework-header">
				...
				<p>A rigorous, disciplined approach to enterprise strategy. We eliminate ambiguity through a structured eight-stage framework designed for high-signal decision making.</p>
			</div>
