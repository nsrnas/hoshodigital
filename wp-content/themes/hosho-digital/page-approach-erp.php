...
<main id="main-content" class="erp-page">
	<style>
		...
		* {
		...
		@media (max-width: 1000px) {
			.opt-gap-grid { grid-template-columns: repeat(3, 1fr); }
			.help-grid { grid-template-columns: repeat(2, 1fr); }
			.success-grid { grid-template-columns: repeat(3, 1fr); }
		}

		@media (max-width: 900px) {
			.erp-hero h1 { font-size: 30px; }
			.opt-gap-grid { grid-template-columns: 1fr 1fr; }
			.help-grid { grid-template-columns: 1fr; }
			.services-grid { grid-template-columns: 1fr; }
			.why-hosho-grid { grid-template-columns: 1fr; }
			.why-hosho-features { grid-template-columns: 1fr; }
			.success-grid { grid-template-columns: 1fr 1fr; }
			.outcome-grid { grid-template-columns: 1fr; }
			.journey-row { gap: 30px; }
			.erp-quote .container { justify-content: flex-start; }
			.erp-quote-photo { position: static; width: 100%; height: 220px; margin-bottom: 20px; }
			.erp-quote-inner { padding: 30px 0 60px; }
		}
	</style>
	...
	<section class="erp-hero">
		<div class="erp-hero-image">
			<img src="<?php echo esc_url( hosho_asset_url( 'images/approach/erp/hero.jpeg' ) ); ?>" alt="Industrial gears over a mountain landscape, representing untapped ERP efficiency">
		</div>
	...
	<section class="erp-quote">
		<div class="erp-quote-photo">
			<img src="<?php echo esc_url( hosho_asset_url( 'images/approach/erp/charles-darwin.png' ) ); ?>" alt="Charles Darwin portrait">
		</div>
		<div class="container">
		...
		<div class="container">
			<div class="why-hosho-grid">
				<div class="why-hosho-card">
					...
					<p>
						We specialize in implementing, customizing, and
						supporting Dynamics 365 Business Central for
						growing organizations. Our approach ensures that the
						solution aligns perfectly with your business processes
						and long-term goals. We provide:
					</p>
				</div>
				...
				<div class="why-hosho-features">
					...
					<div class="feature-card">
						...
						<p>Ongoing support and training for your teams</p>
					</div>
				</div>
			</div>

			<p class="why-hosho-footer">
				Partnering with HOSHŌ Digital means you&rsquo;ll work with a certified Microsoft partner dedicated to
				helping your business realize its full potential through technology.
			</p>
		</div>
	</section>
		...
		<div class="container">
			...
			<div class="outcome-grid">
				...
				<div class="outcome-card style-gray">
					...
					<p>Clean AL code and standard-aligned customizations that make the semi-annual Microsoft release cycle seamless.</p>
				</div>
			</div>
		</div>
	</section>
	...
	<section class="philosophy-strip">
		<div class="container">
			...
			<p>
				We believe that implementation is just the beginning. Our engagement model prioritizes
				long-term partnership&mdash;ensuring that as your business scales, your Dynamics 365
				environment remains a catalyst for innovation rather than a legacy constraint.
			</p>
	...
	<section class="erp-cta">
		<div class="erp-cta-image">
			<img src="<?php echo esc_url( hosho_asset_url( 'images/approach/erp/cta.jpg' ) ); ?>" alt="City skyline at dusk, representing the enterprise landscape">
		</div>
