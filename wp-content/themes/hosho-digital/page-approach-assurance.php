...
<main id="main-content" class="ams-page">
	<!-- HERO -->
	<?php hosho_render_hero( 'BUILD ONCE. <br>IMPROVE CONTINUOUSLY.', 'approach/ams/hero.jpg', array( 'class' => 'page-hero--company' ) ); ?>

	<!-- STATEMENT BANNER -->
	<section class="ams-statement"><div class="container motion"><h3>Applications aren't static. Support can't be either.</h3><p>An AI-powered system needs more than a maintenance contract: models drift, data pipelines break, and dependencies update weekly. AMS is our dedicated team watching that complexity so your internal team doesn't have to.</p></div></section>

	<!-- CONTINUITY FRAMEWORK -->
	<section class="continuity-section"><div class="container motion"><div class="continuity-grid"><div class="continuity-left">
		<h3>Beyond Service Level Agreements:<br>A Strategic Lifecycle</h3>
		<p>Application Management Services (AMS) at HOSHŌ is more than maintenance. It is a continuous operational partnership designed to mitigate risk, optimize performance, and drive architectural innovation in real-time. We don't just keep the lights on; we modernize the grid while it's running.</p>

		<div class="continuity-item"><div class="icon-box"><span class="icon-svg" aria-hidden="true"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/></svg></span></div><div><h4>Implementation</h4><p>The rigorous build and validation phase.</p></div></div>
		<div class="continuity-item"><div class="icon-box"><span class="icon-svg" aria-hidden="true"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 19.5a10 10 0 1 1 15 0"/><path d="M8 16a6 6 0 1 1 8 0"/><circle cx="12" cy="18" r="1"/></svg></span></div><div><h4>Go Live</h4><p>Transitioning from project mode to live operations.</p></div></div>
		<div class="continuity-item"><div class="icon-box"><span class="icon-svg" aria-hidden="true"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7 12.5 4 9.5a3 3 0 0 1 4.2-4.2L12 9l3.8-3.7A3 3 0 1 1 20 9.5l-3 3"/><path d="M9 14l2 2 7-7"/></svg></span></div><div><h4>Continuous Partnership</h4><p>Our long-term commitment to your excellence.</p></div></div>
	</div><div class="continuity-right"><img src="<?php echo esc_url( hosho_asset_url('approach/ams/cycle.png' ) ); ?>" alt="Abstract decorative graphic of layered discs"></div></div></div></section>
	...
	<section class="stay-section"><div class="container motion">
		...
		<div class="timeline-row" style="display: flex; gap: 15px; align-items: stretch; overflow-x: auto; padding: 20px 0;">
			...
			<div class="timeline-arrow" aria-hidden="true" style="color: var(--red); display: flex; align-items: center;"><svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="#E21C15" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg></div>
			<div class="timeline-step"><h4>Support</h4><p>24/7 dedicated engineering expertise.</p></div>
			<div class="timeline-arrow" aria-hidden="true" style="color: var(--red); display: flex; align-items: center;"><svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="#E21C15" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg></div>
			<div class="timeline-step"><h4>Innovation</h4><p>AI-driven updates and next-gen feature sets.</p></div>
		</div>
	</div></section>

	<!-- THE AMS ENGINE -->
	<section class="engine-section"><div class="container motion">
		<div class="engine-header"><h2>Design for The Modern Enterprise</h2><p>Where the framework above shows the three phases of an engagement, this is the operating rhythm we run continuously once Continuous Partnership begins.</p></div>
