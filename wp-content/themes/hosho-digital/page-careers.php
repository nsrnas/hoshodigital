...
<main id="main-content">
  ...
  <?php hosho_render_quote('The people who are crazy enough to think they can change the world are the ones who do.','Steve Jobs','steve-jobs-editorial-v2.png','quote-band--standard quote-band--steve'); ?>
  <section class="section" id="opportunities"><div class="shell intro-grid motion"><div><p class="eyebrow">Get to know us</p><h2>Where do you want to make an impact?</h2></div><div class="editorial-grid career-links"><a class="feature" href="<?php echo esc_url( hosho_page_url( 'company' ) ); ?>"><span class="feature__index">01</span><h3>Our story</h3><p>Learn what HOSHŌ DIGITAL stands for.</p></a><a class="feature" href="<?php echo esc_url( hosho_page_url( 'solutions' ) ); ?>"><span class="feature__index">02</span><h3>Our technology</h3><p>Explore the disciplines behind our work.</p></a><a class="feature" href="<?php echo esc_url( home_url( '/services/' ) ); ?>"><span class="feature__index">03</span><h3>Our services</h3><p>See how we create enterprise value.</p></a></div></div></section>
